import { partition } from "jsr:@std/collections@^1.1.2/partition";
import { sortCollectionByKeys } from "https://raw.githubusercontent.com/hugoalh/sort-es/v0.2.1/collection.ts";
